...
PHPやJavaScriptなど非オブジェクト指向型言語を使用する際、複数のプログラムを組み合わせることで名前の衝突が発生する場合があります。本標準ではプログラムを記述する際の名前の付け方などのルールを設けるものとします。  
...
各ソースコードの先頭には、コメントヘッダを付けるものとする。  
また各クラス、関数、構造体、定数、グローバル変数にも、それらの意味を示すヘッダを付けるものとする。  
